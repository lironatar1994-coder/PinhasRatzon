...
- [x] G10: a human reading the home page top to bottom meets no request for contact details before the practice areas and the approach have been read
  EVIDENCE: re-measured after the FAQ and approach rework (2026-08-29). Document order inside <main> on /: practice-area routing at node 38, approach band at node 102, portrait at node 117, FAQ at node 141, first contact solicitation (form, .btn, tel:, mailto:, wa.me) at node 201 of 248 — i.e. only in the closing section. Hero carries no form and no button. The two .btn nodes on the page are the closing CTA and the submit inside its dialog, at the restraint cap of 2. The new links out of the routing and FAQ bands are text links to /practice-areas/ and /faq/, not asks. Header nav phone link excluded as persistent chrome rather than a page-level ask. (The earlier reading of this gate described a credentials band at node 14 — that band was deleted at the client's call on 2026-08-26 and the evidence line had not been refreshed since.)

...
<section class="statement" id="statement">
  ...
  <div class="wrap narrow statement-inner">
    ...
    <div class="statement-body">
      ...
      <p>כאן נכנס הליווי שלי: עוד לפני שמתחייבים, אני בוחן את התמונה המלאה — הזכויות בנכס, תנאי ההסכם, היבטי המס והרישום — וכל החלקים נשארים תחת אחריות אחת לאורך כל הדרך.</p>
      <p>המטרה פשוטה: שלא תחתמו מתוך תקווה שהכול יסתדר, אלא מתוך הבנה ברורה של העסקה — וליווי עד להשלמתה ברישום.</p>
    </div>
  </div>
</section>
...
<section class="route" id="practice-areas">
  <div class="wrap">
    ${secHead('איך אפשר לעזור', 'איפה אתם נמצאים כרגע?', 'לא צריך לדעת איך קוראים לשירות — רק מה קורה עכשיו. בחרו את המצב הקרוב אליכם: בכל עמוד תמצאו מה חשוב לבדוק, מה עלול להשתבש ואיך מתקדמים.')}
    ${routeList()}
  </div>
</section>
...
<section class="section portrait-sec">
  <div class="wrap">
    ...
    <div class="portrait-copy">
      ...
      <p class="lead">מאז ${esc(BIZ.founded)} אני מלווה קונים, מוכרים ומשפחות — מהבדיקה הראשונה, דרך ההסכם והמיסוי, ועד הרישום וההעברה הבין־דורית.</p>
      <p class="portrait-note">לא תצטרכו להסביר את התיק מחדש. בכל תיק יש כתובת אחת — אני זה שבודק את המסמכים, מנסח את ההסכם ועומד מול הרשויות, כך שהפרטים וההחלטות נשארים אצל מי שמכיר את התמונה המלאה.</p>
